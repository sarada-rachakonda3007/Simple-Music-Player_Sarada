...
def addsongs():
    temp_song = filedialog.askopenfilenames(initialdir="F:/music/", title="Choose a song",
...
# nextbutton
next_button = Button(root, text="Next", width=7, command=nexts)
